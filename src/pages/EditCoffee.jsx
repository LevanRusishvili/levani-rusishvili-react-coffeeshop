...
import "../styles/components/pages/add-coffee.css"; // Reuse the same beautiful CSS
    ...
    return (
      <div className="add-coffee-page">
        <div className="error-state">
          ...
          <p>The coffee you're trying to edit doesn't exist.</p>
          <Button
            variant="primary"
  ...
  return (
    <div className="add-coffee-page">
      <div className="add-coffee-header">
        ...
        <p>Update the details for {coffeeToEdit.name}</p>
      </div>
